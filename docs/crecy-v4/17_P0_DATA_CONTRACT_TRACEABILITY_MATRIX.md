...
| Operator payment export | existing payment, allocation, tenancy, property, unit, household, membership, property-scope persistence + activity index | GetOperatorPaymentExport sanitized CSV query | AAL2; active operator membership; starts_at/ends_at; explicit property scopes; finance.read/manage per row | stable ordering, 5,000-row fail-closed bound, property/book/date validation, AAL1/expired/relationship/outsider denial, formula neutralization, and contact/reason/provider-field absence tests |
