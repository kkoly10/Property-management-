...
export default async function ReceiptPage({ params }: { params: Promise<{ documentId: string }> }) {
  ...
  return <main className="min-h-screen bg-[#f6f8fb] gutter-5 py-5 sm:py-10 print:bg-white print:p-0"><article className="mx-auto max-w-2xl overflow-hidden rounded-2xl border bg-white shadow-sm print:border-0 print:shadow-none">
