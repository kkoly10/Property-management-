    ...
    return (
      <main className="min-h-screen bg-[#f6f8fb] gutter-5 py-5 lg:py-10">
        <div className="mx-auto max-w-xl space-y-8">
          ...
          <Card>
            <CardHeader>
              <span className="mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-muted text-muted-foreground"><UsersRound className="h-6 w-6" /></span>
              <CardTitle>Team invitation unavailable</CardTitle>
              <CardDescription>This invitation cannot be opened right now. Request a new invitation from whoever invited you, or try the link again shortly.</CardDescription>
            </CardHeader>
          </Card>
        </div>
      </main>
