  ...
  return (
    <form action={action} className="space-y-6" noValidate>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2"><Label htmlFor="slug">Workspace identifier</Label><input id="slug" name="slug" className="mt-2 h-10 w-full rounded-md border border-input bg-card px-3 text-sm shadow-xs outline-none focus:ring-2 focus:ring-ring/30" placeholder="northstar" required /><p className="mt-2 text-sm text-muted-foreground">Identifies this Crecy workspace. It is not a public web address.</p><FieldError messages={state.fieldErrors?.slug} /></div>
