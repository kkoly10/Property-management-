...
export function PropertyAccessBoundary() {
  return (
    <figure className="overflow-hidden border-y bg-card">
      <div className="grid border-b lg:grid-cols-[0.85fr_1.15fr]">
